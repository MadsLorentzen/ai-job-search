...
## Task 1: Migration 005 — extension_credentials and handoff_sessions tables
...
**Interfaces:**
- Produces: `HANDOFF_SESSIONS_MIGRATION_ID = "005_handoff_sessions"` constant,
...
git commit -m "feat: add handoff sessions migration 005"
```
...
1. `feat: add handoff sessions migration 005`

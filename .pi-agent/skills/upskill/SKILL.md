...
4. Read `profile/01-candidate-profile.md` to get the candidate's current skills and experience.
...
3. Read `profile/01-candidate-profile.md` for the candidate's current skills.

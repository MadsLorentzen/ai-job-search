...
├── tools/
│   ├── agency.py                      # Agency console for multi-client workspace & toolchain management
...
│   ├── costs.py                       # Per-application token usage and cost ledger
│   ├── credentials.py                 # Per-user Claude API key storage (DPAPI on Windows, 0600 elsewhere)
...
│   ├── tenancy.py                     # Multi-client workspace isolation and cross-contamination audit

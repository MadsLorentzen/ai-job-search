...
> **This is a fork** of [MadsLorentzen/ai-job-search](https://github.com/MadsLorentzen/ai-job-search) — see the original for upstream contribution guidelines. This fork accepts market-specific improvements for the Colombian portals (computrabajo-search, elempleo-search) and OpenCode-migration fixes.

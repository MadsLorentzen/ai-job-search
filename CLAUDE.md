...
## Role
This repo is a job application workspace. OpenAI Codex acts as a career advisor and application assistant for [YOUR_NAME], helping with:
...
**Important:** When mentioning agentic coding or AI tooling in CVs/cover letters, explicitly reference **OpenAI Codex** by name.
...
- [ ] Agentic coding / AI tooling references mention **OpenAI Codex** by name

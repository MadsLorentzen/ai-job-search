---
description: Profile onboarding with three paths: documents folder reading, single CV import, or structured interview mode. Populates all skill files with the candidate's actual information.
---
...
Then proceed to Step 3 to populate the non-skill files (`AGENTS.md`, `cv/main_example.tex`, `.opencode/skill/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 8. Generate `.opencode/skill/job-scraper/search-queries.md`
...
> - `.opencode/skill/job-application-assistant/01-candidate-profile.md` - Structured profile
> - `.opencode/skill/job-application-assistant/02-behavioral-profile.md` - Behavioral assessment
> - `.opencode/skill/job-application-assistant/04-job-evaluation.md` - Personalized evaluation framework
> - `.opencode/skill/job-application-assistant/05-cv-templates.md` - CV templates with your profile statements

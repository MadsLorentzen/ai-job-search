...
const HELP = `elempleo-cli — search jobs on Elempleo Colombia
...
SEARCH FLAGS
  ...
  --location, -l <text>   City (e.g. "Bogotá", "Medellín", "Cali"). Included in query if provided.
...
Personal use only — uses Elempleo's public pages; keep volume low (Elempleo ToS).
`

...
> **Active template override: `classic-single-column`**
>
...
>
> - **Template skeleton:** `templates/cv/classic-single-column/template.tex` — use this as the structural reference instead of the stock template
> - **Manifest:** `templates/cv/classic-single-column/TEMPLATE.md` — read this for style rules and known pitfalls before drafting
> - **Compile with:** `xelatex` (or `pdflatex`)
> - **Fonts:** Standard TeX fonts

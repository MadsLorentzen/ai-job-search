...
|--------|--------|-------------|------------|
| B.Tech in Electronics and Communication Engineering | 2019 – 2023 | National Institute of Technology, Jalandhar (India) | Machine Learning, Signal Processing, Algorithms |

## Professional Experience

### Machine Learning Engineer - II — Revionics (portfolio of Goldman Sachs) (Nov. 2023 – Present)
*Bengaluru, India*
...
### Machine Learning Engineering Intern — Coinbase (May 2023 – Aug. 2023)
*India*
...
### Summer Analyst (SWE Intern) — Goldman Sachs (Jun. 2022 – Jul. 2022)
*Bengaluru, India*
...
- Python (Expert), SQL, C++, FastAPI, Flask, PyTorch, TensorFlow, Scikit-learn

### Machine Learning & LLMs
- RAG Systems, Multi-Agent Systems, Prompt Engineering, Model Finetuning, Vector Databases (FAISS, Pinecone), Inference Optimization, Embeddings, NLP

### Backend & Infrastructure
- REST APIs, Docker, Kubernetes (EKS/GKE), Microservices Architecture, CI/CD, Monitoring, Rate Limiting, Logging & Alerting

### Data & Distributed Systems
- Apache Airflow, Apache Kafka, Databricks, Snowflake, BigQuery, Spark, MSSQL, MongoDB

## Publications
1. Co-Author & Core ML Contributor (Feb. 2026). *SocialPulse: An Open-Source Subreddit Sensemaking Toolkit*. ICWSM 2026 / arXiv ([https://arxiv.org/abs/2602.07248](https://arxiv.org/abs/2602.07248)).
   - Contributed to “SocialPulse: An Open-Source Subreddit Sensemaking Toolkit”, published at ICWSM 2026, developing NLP + GenAI modules to extract structured analytics from unstructured community datasets.

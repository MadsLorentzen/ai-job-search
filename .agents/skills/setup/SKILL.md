...
- **Job portals:** "Are there specific Polish job portals you want to prioritize (e.g. Pracuj.pl, JustJoin.it, NoFluffJobs)?" Note: you can add portal integrations using `/add-portal` or rely on LinkedIn/Google site-searches.

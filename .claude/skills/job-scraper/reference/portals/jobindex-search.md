...
```bash
bun run .claude/skills/job-scraper/scripts/jobindex-search/src/cli.ts search [flags]
```
...
```bash
bun run .claude/skills/job-scraper/scripts/jobindex-search/src/cli.ts detail <id> [--format json|plain]
```
...
```bash
bun run .claude/skills/job-scraper/scripts/jobindex-search/src/cli.ts search \
  --query python \
  --jobage 7 \
  --sort date \
  --format table
...
```bash
bun run .claude/skills/job-scraper/scripts/jobindex-search/src/cli.ts detail h1647303 --format plain
```

...
- Requires relocation within the EU: PASS (candidate is willing to relocate)
- Requires relocation outside the EU: FLAG (check work authorization and practical constraints)

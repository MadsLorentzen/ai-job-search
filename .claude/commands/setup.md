...
- **Job portals:** "The framework ships a LinkedIn-based search CLI plus web-search coverage of portals such as Naukri, Foundit, Shine, TimesJobs, and Instahyre. Which sites do you actually use?" Note: if the user relies on other boards, suggest `/add-portal` to scaffold a direct integration for any public portal.
